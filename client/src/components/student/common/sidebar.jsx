...
const SIDEBAR_ITEMS = [
  ...
  },
  {
    ...
    icon: CalendarClock,
    color: "#8b5cf6",
    href: "/student/dashboard/Studentcelender",
  },
  {
    section: "Assignments",
    icon: ClipboardList,
    color: "#ef4444",
    href: "/student/dashboard/StudentAssegment",
  },
  {
    section: "Grades",
    icon: FileText,
    color: "#f59e0b",
    href: "/student/dashboard/StudentGradebook",
  },
  {
    section: "Attendance",
    icon: UserCheck,
    color: "#10b981",
    href: "/student/dashboard/TudentattendancePage",
  },
  {
    section: "Messages",
    icon: MessageSquare,
